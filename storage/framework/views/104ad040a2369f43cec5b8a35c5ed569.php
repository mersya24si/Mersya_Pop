                                    ...
                                    <a href="#" class="list-group-item list-group-item-action border-bottom">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col ps-0 ms-2">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <h4 class="h6 mb-0 text-small">Mersya</h4>
                                                    </div>
                                                    <div class="text-end">
                            ...
                            <a class="nav-link dropdown-toggle pt-1 px-0" href="#" role="button"
                                ...
                                <div class="media d-flex align-items-center">
                                    ...
                                    <div class="media-body ms-2 text-dark align-items-center d-none d-lg-block">
                                        <span class="mb-0 font-small fw-bold text-gray-900"><?php echo e(Auth::user()->email); ?></span>
                                    </div>
                                </div>
                            </a>
                            <?php endif; ?>
...
<?php /**PATH D:\MersyaMeylaniPutri_2SID\laragon-6.0-minimal\www\mersya_pop\resources\views/layouts/admin/header.blade.php ENDPATH**/ ?>